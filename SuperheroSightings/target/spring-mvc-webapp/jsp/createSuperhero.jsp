        ...
        <div class="container">
            ...
            <div class="col-md-6 row">
                <sf:form class="form-horizontal" role="form" modelAttribute="superhero" 
                         action="createSuperhero" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-superpower" path="superpower" placeholder="Enter Superpower"/>
