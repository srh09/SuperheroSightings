            ...
            <div class="col-md-6 row">
                <sf:form class="form-horizontal" role="form" modelAttribute="location"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-address" path="address" placeholder="Enter Address"/>
                            <sf:errors path="address" cssclass="error"></sf:errors>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="coordinates" class="col-md-4 control-label">Coordinates:</label>
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-coordinates" path="coordinates" placeholder="Enter Coordinates"/>
