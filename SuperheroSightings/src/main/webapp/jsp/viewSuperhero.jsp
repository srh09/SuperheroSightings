            ...
            <div class="col-md-6 row">
                <sf:form class="form-horizontal" role="form" modelAttribute="superhero" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-superpower" path="superpower" disabled="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="orgTable" class="col-md-4 control-label">
                            Organizations:
                        </label>
                        <div id="scrollTable" name="orgTable" class="col-md-4 row">
