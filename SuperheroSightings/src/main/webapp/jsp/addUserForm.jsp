...
<html>
    ...
    <body>
        <div class="container">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="user" action="addUser" method="POST">
                    <div class="form-group">
                        ...
                        <div class="form-check col-md-offset-2">
                            ...
                            <br><input type="submit" class="btn btn-primary col-md-offset-2" value="Add User"/><br/>
                </sf:form>
            </div>
        </div>
